  ...
  return {
    ...
    months: {
      '7': { phase: '準備（始動）＋初戦', headline: '代替わり後の立ち上げ。型づくり＝固定形を体に入れる', peak: null, peak_level: 0,
        focus_weights: { 'コンディショニング/ウォームアップ': 0.1, 'ハンドリング/ドリブル': 0.15, 'フィニッシュ(ゴール下/レイアップ)': 0.2, 'シュート': 0.1, 'チームオフェンス(アーリー/トランジション)': 0.15, 'チームディフェンス(オールコートマンツー/ヘルプ/帰陣)': 0.15, '意思決定/ゲーム形式': 0.1, '1on1': 0.05 },
      ...
      '8': { phase: '準備（積み上げ）', headline: '点の取り方の土台を積み上げる。DF基礎を3on3で', peak: null, peak_level: 0,
        focus_weights: { 'ハンドリング/ドリブル': 0.15, 'フィニッシュ(ゴール下/レイアップ)': 0.2, 'シュート': 0.1, 'チームオフェンス(アーリー/トランジション)': 0.15, 'チームディフェンス(オールコートマンツー/ヘルプ/帰陣)': 0.15, '意思決定/ゲーム形式': 0.15, '1on1': 0.1 },
        kpi_hints: ['ゴール下/レイアップ成功率', '守備姿勢維持'] },
      '9': { phase: '準備（積み上げ）', headline: '得点の基礎を実戦（1on1/3on3/5on5）に乗せ強度を上げる', peak: null, peak_level: 0,
        focus_weights: { 'ハンドリング/ドリブル': 0.15, 'フィニッシュ(ゴール下/レイアップ)': 0.15, 'シュート': 0.15, '1on1': 0.25, '意思決定/ゲーム形式': 0.15, 'チームディフェンス(オールコートマンツー/ヘルプ/帰陣)': 0.1, 'パス&スペーシング': 0.05 },
        kpi_hints: ['1on1得点', '被OR'] },
      '10': { phase: '鍛錬', headline: '個の攻めを磨きDFのチーム連携を3on3〜5on5で固める', peak: null, peak_level: 0,
        focus_weights: { '1on1': 0.2, 'シュート': 0.2, 'チームディフェンス(オールコートマンツー/ヘルプ/帰陣)': 0.2, '意思決定/ゲーム形式': 0.15, 'フィニッシュ(ゴール下/レイアップ)': 0.15, 'ハンドリング/ドリブル': 0.1 },
        kpi_hints: ['FT率', '被FG%'] },
      '11': { phase: '試合期（新人大会）', headline: '新人大会で勝つ（冬の力試し）。攻め＋DF徹底を実戦で出す', peak: 'winter_shinjin', peak_level: 1,
        focus_weights: { '意思決定/ゲーム形式': 0.3, '1on1': 0.2, 'チームディフェンス(オールコートマンツー/ヘルプ/帰陣)': 0.2, 'チームオフェンス(アーリー/トランジション)': 0.1, 'シュート': 0.1, 'フィニッシュ(ゴール下/レイアップ)': 0.1 },
        kpi_hints: ['試合TO', 'FT率'] },
      '12': { phase: '試合期（締め・振り返り）', headline: '新人大会の締めと振り返り。次への課題出し', peak: 'winter_shinjin', peak_level: 1,
        focus_weights: { '意思決定/ゲーム形式': 0.3, 'チームディフェンス(オールコートマンツー/ヘルプ/帰陣)': 0.15, '1on1': 0.15, 'シュート': 0.15, 'フィニッシュ(ゴール下/レイアップ)': 0.15, 'チームオフェンス(アーリー/トランジション)': 0.1 },
        kpi_hints: ['試合スタッツ全般'] },
      '1': { phase: '試合期（都新人大会）', headline: '都新人大会。攻めは継続', peak: 'winter_shinjin', peak_level: 1,
        focus_weights: { '意思決定/ゲーム形式': 0.3, '1on1': 0.2, 'チームディフェンス(オールコートマンツー/ヘルプ/帰陣)': 0.15, 'チームオフェンス(アーリー/トランジション)': 0.15, 'シュート': 0.1, 'フィニッシュ(ゴール下/レイアップ)': 0.1 },
        kpi_hints: ['試合スタッツ全般'] },
      ...
      '3': { phase: '移行', headline: '研修大会。翌4月に新1年が加入＝次の代へ', peak: null, peak_level: 0,
        focus_weights: { '1on1': 0.2, 'フィニッシュ(ゴール下/レイアップ)': 0.2, 'ハンドリング/ドリブル': 0.2, 'シュート': 0.15, 'チームディフェンス(オールコートマンツー/ヘルプ/帰陣)': 0.15, 'コンディショニング/ウォームアップ': 0.1 },
        kpi_hints: [] },
      '4': { phase: '再編成', headline: '新年度。新1年が加入。基礎立ち上げ＋チームを組み直す', peak: null, peak_level: 0,
        focus_weights: { 'コンディショニング/ウォームアップ': 0.15, 'ハンドリング/ドリブル': 0.2, 'フィニッシュ(ゴール下/レイアップ)': 0.2, 'シュート': 0.15, '1on1': 0.15, 'チームディフェンス(オールコートマンツー/ヘルプ/帰陣)': 0.15 },
        kpi_hints: ['ハンドリング落球'] },
      '5': { phase: '試合準備', headline: '中体連へ仕上げ。実戦化し強度を上げる', peak: 'summer_chutairen', peak_level: 1,
        focus_weights: { '1on1': 0.2, 'チームディフェンス(オールコートマンツー/ヘルプ/帰陣)': 0.2, 'チームオフェンス(アーリー/トランジション)': 0.2, '意思決定/ゲーム形式': 0.15, 'シュート': 0.15, 'フィニッシュ(ゴール下/レイアップ)': 0.1 },
        kpi_hints: ['試合TO', 'FG%'] },
